...
import com.sbicloudbd.base.BaseEntity;
import com.sbicloudbd.utils.NullOrEmpty;
...
public class EmployeeCoreInfo extends BaseEntity {
    @Id
    @Column(name = "id")
    ...
    private String getFullNameWithPin() {
        StringBuilder stringBuilder = new StringBuilder();
        if (NullOrEmpty.isNotNullOrEmpty(this.getPinNo())) {
            stringBuilder.append("[ ");
            stringBuilder.append(this.getPinNo());
            stringBuilder.append(" ] ");
        }
        if (NullOrEmpty.isNotNullOrEmpty(this.getFirstName())) {
            stringBuilder.append(this.getFirstName());
        }
        if (NullOrEmpty.isNotNullOrEmpty(this.getMiddleName())) {
            stringBuilder.append(" ");
            stringBuilder.append(this.getMiddleName());
        }
        if (NullOrEmpty.isNotNullOrEmpty(this.getLastName())) {
            stringBuilder.append(" ");
